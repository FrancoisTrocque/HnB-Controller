...
// if NULL the function manage to be OFF
...
void DC22_PedalageProcess(u8 *pu8Pedalage)
{
    ...
    // detect rising edge on "Pedalage" only if bRun=TRUE
    ...
    // NO rising edge detected on "Pedalage" or bRun = FALSE
    else
    {
